...
// Modified by Lasse Oorni, Yao Wei Tjong, Rainer Deyke, and Nathanial Lydick for Urho3D
...
#endif // Urho3D: end check first if renderer is disabled
...
{
    SDL_Window *window;
    // Urho3D: moved to function arguments
